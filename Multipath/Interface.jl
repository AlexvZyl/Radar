...
# Plot the flat earth lobe structure.
hr = 3
R_range = 10:100:40000
f = 1.1e9
θ_range = 0:(π/2)/500:π/2
dB_range = (20, 50)
# dB_range = false
# file_name = "MP_LOBE_STRUCTURE_FLAT_EARTH.pdf"
# figure = plot_lobe_structure_flat_earth(hr, R_range, f, θ_range, dB_range = dB_range)
# save(file_name, figure)
